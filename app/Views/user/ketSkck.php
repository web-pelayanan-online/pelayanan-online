...
<div class="container">
    <div class="form">
        <form action="<?= base_url('/pengajuan/surat_skck'); ?>" method="post" class="data" style="padding:15px;">
            <div class="row">
                <div class="header p-3 text-md text-center" style="color:black; background-color:#b78a02; border-radius: 10px;">
                    <h2>Surat Keterangan Pengantar SKCK</h2>
                </div>
                <div class="batas p-3"></div>
                <div class="col">
                    <input type="hidden" name="nama_surat" value="Surat Keterangan Pengantar SKCK">
                    <div class="mb-3">
